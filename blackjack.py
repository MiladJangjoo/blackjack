...
class BlackJack():
    ...
    def player (self):
        one = self.startingDeck[0]
        two = self.startingDeck[1]
        self.playerHand.append(one)
        self.playerHand.append(two)
        self.startingDeck.remove(one)
        self.startingDeck.remove(two)
    ...
    def dealer (self):
        one = self.startingDeck[0]
        two = self.startingDeck[1]
        self.dealerHand.append(one)
        self.dealerHand.append(two)
        self.startingDeck.remove(one)
        self.startingDeck.remove(two)
        print (self.startingDeck)
